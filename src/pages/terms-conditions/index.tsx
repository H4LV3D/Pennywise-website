    ...
    <>
      ...
      <PageLayout>
        <>
          ...
          <div className="grid grid-cols-12 gap-x-0 lg:gap-x-6 pt-8 h-[100vh] ">
            <div
              id="parent"
              className="col-span-12 lg:col-span-8 h-full no-scrollbar overflow-y-scroll "
            >
              <div className="w-full space-y-6 max-w-3xl ">
                ...
                <div className="space-y-4 ">
                  ...
                  <div className="space-y-4">
                    ...
                    <p className="dark:text-neutral-300 text-[#222] tracking-wider leading-6  mt-0.5 ">
                      <span className="font-bold  p-brand-dark-blue ">You</span>{" "}
                ...
                <div className="space-y-4">
                  ...
                  <p className="dark:text-neutral-300 text-[#222] tracking-wider leading-6  mt-0.5 ">
                    ...
                    of the company&rsquo;s provider makes any representation or
