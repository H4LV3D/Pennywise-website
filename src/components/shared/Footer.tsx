...
function Footer({}: Props) {
  ...
  return (
    <>
      <div className="w-full overflow-x-hidden font-raleway  dark:bg-[#000B17] dark:text-neutral-400 py-20">
        <div className="px-6 md:px-0 md:container mx-auto xl:w-[1250px]">
          ...
          <div className="flex justify-between md:grid grid-cols-1 sm:grid-cols-2 items-center py-2 mt-4">
